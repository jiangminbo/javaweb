...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>铜雀台整形医院</title>
		<meta name="keywords" content="铜雀台整形医院">
		<meta name="content" content="铜雀台整形医院">
					...
					<div class="bj_bai">
						...
						<form action="" method="get">
							<input name="" type="text" class="kuang_txt phone"
								placeholder="手机号">
							<input name="" type="text" class="kuang_txt email"
								placeholder="邮箱">
							...
							<div>
								...
								<span>已阅读并同意<a href="#" target="_blank"><span
										class="lan">《XXXXX使用协议》</span>
								</a>
								</span>
							</div>
